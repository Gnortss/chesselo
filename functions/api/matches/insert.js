export async function onRequestPost(context) {
    try {
        ...
        const ps = context.env.CHESSELO_DB.prepare(`INSERT INTO matches (id, p1_id, p2_id, p1_wins, p2_wins, p1_rating_diff, p2_rating_diff, created_at) VALUES ("${payload.id}", "${payload.p1_id}","${payload.p2_id}", ${payload.p1_wins}, ${payload.p2_wins}, ${payload.p1_rating_diff}, ${payload.p2_rating_diff}, ${payload.created_at});`);
